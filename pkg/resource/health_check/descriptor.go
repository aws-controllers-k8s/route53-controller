...
const (
	FinalizerString = "finalizers.route53.services.k8s.aws/HealthCheck"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("healthchecks")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.HealthCheck{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.HealthCheck),
	}
}
