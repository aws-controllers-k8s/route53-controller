...
const (
	FinalizerString = "finalizers.route53.services.k8s.aws/HostedZone"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("hostedzones")
