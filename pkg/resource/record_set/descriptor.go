...
const (
	finalizerString = "finalizers.route53.services.k8s.aws/RecordSet"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("recordsets")
