...
const (
	finalizerString = "finalizers.route53.services.k8s.aws/CIDRCollection"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("cidrcollections")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.CIDRCollection{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.CIDRCollection),
	}
}
