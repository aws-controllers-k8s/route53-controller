...
// +kubebuilder:rbac:groups=route53.services.k8s.aws,resources=cidrcollections,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=route53.services.k8s.aws,resources=cidrcollections/status,verbs=get;update;patch
