...
// +kubebuilder:rbac:groups=route53.services.k8s.aws,resources=trafficpolicies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=route53.services.k8s.aws,resources=trafficpolicies/status,verbs=get;update;patch
