...
const (
	finalizerString = "finalizers.route53.services.k8s.aws/TrafficPolicy"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("trafficpolicies")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.TrafficPolicy{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.TrafficPolicy),
	}
}
