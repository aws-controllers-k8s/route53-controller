...
func (in *TrafficPolicySummary) DeepCopyInto(out *TrafficPolicySummary) {
	*out = *in
	...
	if in.TrafficPolicyCount != nil {
		in, out := &in.TrafficPolicyCount, &out.TrafficPolicyCount
		*out = new(int64)
		**out = **in
	}
	if in.Type != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TrafficPolicy_SDK) DeepCopyInto(out *TrafficPolicy_SDK) {
	*out = *in
	if in.Comment != nil {
		in, out := &in.Comment, &out.Comment
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TrafficPolicy_SDK.
func (in *TrafficPolicy_SDK) DeepCopy() *TrafficPolicy_SDK {
	if in == nil {
		return nil
	}
	out := new(TrafficPolicy_SDK)
	in.DeepCopyInto(out)
	return out
}
