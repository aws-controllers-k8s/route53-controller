...
{{- define "ack-route53-controller.app.name" -}}
...
*/}}
{{- define "ack-route53-controller.app.fullname" -}}
...
{{- define "ack-route53-controller.chart.name-version" -}}
{{- printf "%s-%s" .Chart.Name .Chart.Version | replace "+" "_" | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{/* The name of the service account to use */}}
{{- define "ack-route53-controller.service-account.name" -}}
...
{{- define "ack-route53-controller.aws.credentials.secret_mount_path" -}}
{{- "/var/run/secrets/aws" -}}
{{- end -}}

{{/* The path the shared credentials file is mounted */}}
{{- define "ack-route53-controller.aws.credentials.path" -}}
{{ $secret_mount_path := include "ack-route53-controller.aws.credentials.secret_mount_path" . }}
{{- printf "%s/%s" $secret_mount_path .Values.aws.credentials.secretKey -}}
{{- end -}}

{{/* The rules a of ClusterRole or Role */}}
{{- define "ack-route53-controller.rbac-rules" -}}
rules:
- apiGroups:
  - ""
  resources:
